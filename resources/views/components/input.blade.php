...
<input {{ $disabled ? 'disabled' : '' }} {!! $attributes->merge([
    'class' => 'w-full bg-white border border-tbn-light text-gray-900 placeholder-gray-400
        ...
        px-3 py-2 rounded-lg transition-colors duration-300 disabled:cursor-not-allowed disabled:opacity-50',
]) !!}>
