    ...
    <section class="w-full select-none md:w-3/5">
        <div
            ...
            <div class="my-3">
                ...
                <div
                    class="text-tbn-dark dark:text-white font-normal break-normal [&_ol]:list-disc [&_ol]:ml-4 [&_span]:bg-transparent [&_a]:underline [&_a]:text-tbn-primary [&_h1]:text-2xl [&_h2]:text-xl [&_h3]:text-lg text-sm">
