<div class="flex flex-row gap-6">
    <!-- Result description -->
    <section class="w-3/5 bg-white rounded-lg shadow-md p-10" x-data="content">
        @if ($pro_flag)
        ...
        @else
            <div class="text-center max-w-xl mx-auto">
                <i class="fas fa-crown text-5xl text-orange-500 mb-4"></i>
                <h5 class="text-2xl font-bold mb-2">Oops, al parecer no eres PRO</h5>
                <p class="text-md text-tbn-dark mb-4">La convocatoria que intentas ver está solo disponible para los
                    clientes de <a class="text-tbn-primary underline" href="{{ route('welcome') }}"
                        wire:navigate>trabajonautas.com</a> registrados con una cuenta PRO.</p>
                <x-button href="{{ route('purchase') }}" wire:navigate>Obtener PRO</x-button>
            </div>
        @endif
        {{-- Modal Share --}}
        <div class="fixed z-10 inset-0 overflow-y-auto" id="modal-share" x-show="modalShare" x-cloak x-transition.fade>
            <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div class="inline-block align-bottom bg-white rounded-lg px-5 py-3  text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
