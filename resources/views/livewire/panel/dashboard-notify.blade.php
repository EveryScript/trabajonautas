<section x-data="subcontent" class="flex flex-col gap-4">
    ...
    @forelse ($announces as $announce)
        <div wire:key='announce-{{ $announce->id }}' x-data="{
            ...
            x-show="filter_option === 'all' || (filter_option === 'today' && info.today) || (filter_option === 'week' && info.week) || (filter_option === 'month' && info.month)"
    ...
    @empty
        <x-section-empty class="col-span-2" title="Las mejores convocatorias están por llegar"
            description="Permanece atento a las notificaciones y revisa esta área de vez en cuando.">
