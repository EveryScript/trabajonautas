    ...
    <div class="bg-white rounded-md shadow-md px-7 py-5" x-data="content">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-2">
            ...
            <div class="border border-gray-300 rounded-lg shadow-lg px-5 py-4">
                ...
                <p class="mb-5 text-tbn-dark text-sm">Cantidad total: {{ array_sum($tbn_clients['data']) }}</p>
            ...
            <div class="col-span-3 border border-gray-300 rounded-lg shadow-lg px-5 py-4">
                <h4 class="text-lg text-tbn-dark font-bold mb-1">Usuarios según ubicación</h4>
            ...
            <div class="col-span-4 border border-gray-300 rounded-lg shadow-lg px-5 py-4"
                ...
                <p class="mb-5 text-tbn-dark text-sm">Cantidad total: {{ array_sum($tbn_announces_area['data']) }}</p>
