...
<head>
    ...
    <title>Trabajonautas.com tiene un aviso para ti.</title>
    <style>
...
<body>
    <div class="wrapper">
        <div class="container">
            ...
            <!-- Cuerpo -->
            <div class="content">
                <span class="hero-badge">Tu cuenta está por expirar</span>
                <h1 class="title">¡Hola, 👩‍🚀 {{ $user->name }}!</h1>
                <p class="text">
                    Trabajonautas te informa que tu cuenta va a expirar en 2 días.
                </p>
                <p class="text">
                    Renueva tu cuenta ahora mismo para seguir disfrutando de los beneficios junto a Trabajonautas.com.
                    Ingresa a tu <strong>Panel de Control</strong> y presiona el botón "Renovar cuenta" antes de que se
                    agote tu tiempo.
                </p>
                <div class="cta-box">
