<x-web-layout>
            ...
            <div class="">
                ...
                <div class="mx-auto sm:mx-0">
                    <div class="flex flex-col sm:flex-row gap-2 text-center sm:text-left">
                        ...
                        <x-button-link class="bg-tbn-secondary" href="{{ route('purchase-cards') }}" wire:navigate>Comprar
                            ahora</x-button-link>
                    </div>
                </div>
            </div>
    ...
    <section class="max-w-6xl sm:px-6 px-5 py-24 mx-auto">
        <div class="text-center py-5">
            ...
            <p class="text-center text-tbn-dark text-sm mb-5">Cada convocatoria es una oportunidad única para ti y en
    ...
    <section class="body-font">
        <div class="max-w-6xl px-5 py-24 mx-auto">
            ...
            <p class="text-tbn-dark text-center text-sm mb-10">Sigue las instrucciones y forma parte de la comunidad más
                grande
                de
                profesionales para
            ...
            <div class="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6">
                <div class="p-4 md:w-1/3 flex">
                    ...
                    <div class="flex-grow pl-6">
                        ...
                        <p class="leading-relaxed text-base text-tbn-dark">Ingresa tu correo y contraseña para que te
                            enviemos
                ...
                <div class="p-4 md:w-1/3 flex">
                    ...
                    <div class="flex-grow pl-6">
                        ...
                        <p class="leading-relaxed text-base text-tbn-dark">Encuentra información sobre convocatorias
                            laborales de toda
                ...
                <div class="p-4 md:w-1/3 flex">
                    ...
                    <div class="flex-grow pl-6">
                        ...
                        <p class="leading-relaxed text-base text-tbn-dark">Agrega tus convocatorias favoritas en tu
                            perfil y
    ...
    <section class="bg-tbn-primary text-white body-font">
        <div class="max-w-6xl mx-auto flex md:flex-row flex-col-reverse items-center px-5 gap-0 md:gap-10">
            ...
            <div class="md:w-3/5 py-12 text-center md:text-left">
                <h4 class="font-baloo sm:text-4xl text-3xl mb-4 md:mt-0 mt-20 font-bold">Tu futuro profesional es nuestra motivación
                    más grande.</h4>
            ...
            <div class="flex md:flex-row flex-col justify-center -m-4">
                <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                    <div class="h-full text-center">
                        ...
                        <p class="leading-relaxed max-w-[30rem] mx-auto">"Gracias a esta plataforma, pude encontrar el trabajo que estaba
                ...
                <div class="lg:w-1/3 lg:mb-0 mb-6 p-4">
                    <div class="h-full text-center">
                        <img alt="testimonial"
                            class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100"
                            src="{{ asset('storage/img/tbn-default.webp') }}">
                        <p class="leading-relaxed max-w-[30rem] mx-auto">"La empresa se preocupa realmente por conectar a los profesionales
                ...
                <div class="lg:w-1/3 lg:mb-0 p-4">
                    <div class="h-full text-center">
                        <img alt="testimonial"
                            class="w-20 h-20 mb-8 object-cover object-center rounded-full inline-block border-2 border-gray-200 bg-gray-100"
                            src="{{ asset('storage/img/tbn-default.webp') }}">
                        <p class="leading-relaxed max-w-[30rem] mx-auto">"Lo que más me gusta es la transparencia y el compromiso que tienen
