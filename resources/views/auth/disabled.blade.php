    ...
    <section class="flex items-center justify-center min-h-screen bg-gradient-to-br">
        <div class="max-w-xl text-center">
            ...
            <form class="px-4" method="POST" action="{{ route('logout') }}" x-data>
                @csrf
                <a href="https://wa.me/{{ config('trabajonautas.support_phone') }}?text=Hola%20Trabajonautas.com%2C%20parece%20que%20mi%20cuenta%20ha%20sido%20desactivada%2C%20por%20que%20ha%20ocurrido%20esto%3F"
                    target="_blank">
